...
// P50kBaseAPIService is a service that implements the logic for the P50kBaseAPIServicer
// This service should implement the business logic for every endpoint for the P50kBaseAPI API.
// Include any external packages or services that will be required by this service.
type P50kBaseAPIService struct {
}

// NewP50kBaseAPIService creates a default api service
func NewP50kBaseAPIService() *P50kBaseAPIService {
	return &P50kBaseAPIService{}
}

// EncodeP50kBasePost - Upload text file for p50k_base encoding
func (s *P50kBaseAPIService) EncodeP50kBasePost(ctx context.Context, filename *os.File) (ImplResponse, error) {
	...
	encoding, err := tiktoken.NewEncodingForModel("text-davinci-002")
	if err != nil {
